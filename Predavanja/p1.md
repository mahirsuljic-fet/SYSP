### Sadržaj
- [Uvod](#uvod)
- [XV6 fajl sistem](#XV6-fajl-sistem)
- [`inode`](#inode)
...
Diskovi generalno podržavaju dvije operacije: `get` (čitanje podataka) i `set` (pisanje podataka).
...
Kako bi znali gdje se nalaze podaci na disku i kako su organizovani koristi se fajl sistem.
...
### Ostalo
Sistemski pozivi koji se koriste za interakciju sa hardverom (ne trebaju nam sada, ignorisati): \
